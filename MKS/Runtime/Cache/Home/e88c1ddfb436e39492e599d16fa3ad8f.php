...
$("#dd").click(function(){
    ...
    //         // 获取years和dep
    //         var years = $("#years").val();
    //         var id = '<?php echo ($inf["info"]["id"]); ?>';
    //         var userName = '<?php echo (cookie('user_name')); ?>';
    //         layer.confirm("你将下载“马克思学院"+years+"年度"+userName+"成果汇总表”", {
    //             btn: ['确定','取消'], //按钮
    //                time:10000
    //             }, function(){
    //                var url = "<?php echo U('Home/excelUser?years=years1&id=id1');?>";
...
<div style="position: absolute;left: 200px;top: 60px;color: #AAAAAA;width: 820px;">
 ...
 <hr>           
             <form action="<?php echo U('Home/generalTeacher');?>" method="POST">
               ...
               <!--  <a href="javascript:void(0)" id="download"><span class="glyphicon glyphicon-save" style="font-size: 20px"></span></a> -->
